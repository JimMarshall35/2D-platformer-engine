...
#include <memory>
#include <type_traits>
// State Machine Library 2022 Jim Marshall.
// "Pacific State
// based on the C# library 'Stateless' https://github.com/dotnet-state-machine/stateless
namespace PS {
...
#pragma endregion
    ...
    public:
        ...
        StateMachine();
        ~StateMachine();
        void Intialize(int numstates, int numtriggers, TState initialState);
        void RunActive();
...
#pragma region StateMachine
    ...
    {
        Intialize(numstates, numtriggers, initialState);
    }
    ...
    template<typename TState, typename TTrigger>
    inline void StateMachine<TState, TTrigger>::Intialize(int numstates, int numtriggers, TState initialState)
    {
